...
using Avalonia2DWorld.Generation.TestApp.Persistence;
using Avalonia2DWorld.Map.Models;
using Avalonia2DWorld.Map.ViewModels;
using Avalonia2DWorld.MapServices.Constants;
using Avalonia2DWorld.MapServices.Editing;
using Avalonia2DWorld.MapServices.ExtensionMethods;
using Avalonia2DWorld.MapServices.MapRenderComponents.StandardRenderer;
using Avalonia2DWorld.MapServices.Persistence;
using Avalonia2DWorld.MapServices.Renderers;

namespace Avalonia2DWorld.Generation.TestApp.ViewModels;
...
public partial class MainWindowViewModel : MapViewModelBase
{
    ...
    [ObservableProperty]
    private string _title = "Avalonia2DWorld Test";
